          ...
          >
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                <Badge className="bg-gradient-to-r from-pink-500 to-purple-600 text-white">{award.year}</Badge>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {recognitions.map((recognition, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 p-3 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg hover:from-pink-100 hover:to-purple-100 transition-all duration-300"
                >
