      ...
      <div className="max-w-2xl mx-auto mb-12 animate-slide-in-up" style={{ animationDelay: "0.1s" }}>
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-12 border-pink-200 focus:border-pink-400 focus:ring-pink-400 transition-all duration-300"
          />
        </div>
      </div>
          ...
          <Card className="hover-lift animate-slide-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </Button>
              </form>
