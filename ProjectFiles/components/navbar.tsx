                ...
                <nav className="flex flex-col space-y-4 mt-8">
                  {navItems.map((item) => (
                    <Link
                      key={item.href}
                      href={item.href}
                      className="flex items-center space-x-3 text-lg font-medium p-3 rounded-lg hover:bg-pink-50 hover:text-pink-600 transition-all duration-300 hover-lift"
                    >
                  ...
                  {!isLoggedIn && (
                    <div className="flex flex-col space-y-2 pt-4">
                      ...
                      <Button className="justify-start bg-gradient-to-r from-pink-500 to-purple-600" asChild>
                        <Link href="/auth/register">Sign Up</Link>
                      </Button>
                    </div>
                  )}
