  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap gap-4 mb-8 animate-slide-in-up" style={{ animationDelay: "0.2s" }}>
        <Button
          variant="outline"
          className="hover:bg-amber-50 hover:border-amber-300 transition-all duration-300 bg-transparent"
        >
          ...
          >
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500">
                <div className="flex items-center space-x-1 hover:text-amber-700 cursor-pointer transition-colors duration-200">
