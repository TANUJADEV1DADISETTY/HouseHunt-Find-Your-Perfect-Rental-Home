      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between animate-slide-in-up">
            ...
            <Button className="bg-gradient-to-r from-amber-600 to-yellow-700 hover:from-amber-700 hover:to-yellow-800 transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        {post.trending && (
                          <Badge className="bg-gradient-to-r from-amber-600 to-yellow-700 text-white text-xs">
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {post.tags.map((tag, tagIndex) => (
                    <Badge
                      key={tagIndex}
                      variant="outline"
                      className="text-xs hover:bg-amber-50 transition-colors duration-200"
                    >
                      #{tag}
                    </Badge>
                  ))}
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  <div className="flex items-center space-x-4">
                    <button className="flex items-center space-x-1 hover:text-amber-700 transition-colors duration-200">
          ...
          <Card className="hover-lift animate-slide-in-up" style={{ animationDelay: "0.3s" }}>
            ...
            <CardContent className="space-y-4">
              {upcomingEvents.map((event) => (
                <div key={event.id} className="p-3 border rounded-lg hover:bg-amber-50 transition-colors duration-200">
