...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-500 to-pink-600 text-white animate-gradient">
      {/* Floating elements */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-1/3 animate-float" style={{ animationDelay: "0.5s" }}>
          <div className="w-6 h-6 bg-rose-300 rounded-full opacity-30"></div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-left">
          ...
          >
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Button
                size="lg"
                className="h-12 px-8 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 transform hover:scale-105 transition-all duration-300 animate-pulse-glow"
                asChild
              >
